...
my $server0 = { $HOSTNAME => "world.cs.vu.nl" };
my $server1 = { $HOSTNAME => "globule.revolutionware.net" };
my $server2 = { $HOSTNAME => "www.host.revolutionware.net" };
...
push @my_hostnames, "www.host.revolutionware.net";
